...
$con=mysqli_connect("localhost","root","","naekana_bus");
$q=mysqli_query($con,"select pnr,bus_no,booking_status,payment_id, customer_id from payment_details where pnr='".$_SESSION['user']."'");
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------<br>
<center><h3>NAEKANA BUS TICKET RESERVATION</h3></center>
		...
		<div class="margin-top">
			<div class="row">	
								<div class="alert alert-info">
                                    ...
                                    <strong>&nbsp;Valid Bus Tickets</strong>
                                </div>
