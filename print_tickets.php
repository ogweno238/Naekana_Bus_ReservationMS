            ...
            <div class="span3">
                ...
                <div>
                    <ul class="nav  nav-pills nav-stacked" style="background-color:#C96">
                        ...
                        <li>
                        <a href="customer_homepage.php"><i class="fa fa-bus" aria-hidden="true"></i> Book Bus Tickets</a>
				
				</li>
				<li class="active"><a href="booked_tickets.php"><i class="fa fa-bus" aria-hidden="true"></i> View Booked Bus Tickets</a>
				</li>
				<li><a href="print_tickets.php"><i class="fa fa-bus" aria-hidden="true"></i> Print Booked Ticket</a>
				</li>
				<li><a href="cancel_booked_tickets.php"><i class="fa fa-bus" aria-hidden="true"></i> Cancel Booked Bus Tickets</a>
				</li>
                                ...
                                <?php include('dbcon.php'); ?>
                                 <?php  $user_query=mysql_query("select * from payment_details where customer_id='".$_SESSION['login_user']."'")or die(mysql_error());
									...
									$cat_id=$row['bus_no'];
											...
											$cat_query = mysql_query("select * from 	bus_details where bus_no = '$cat_id'")or die(mysql_error());
