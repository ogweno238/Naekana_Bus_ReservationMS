     ...
     <div class="container">
        <div class="row-fluid">
            <div class="span3">
                ...
                <li  class="active"><a href="activate_bus.php"><i class="fa fa-bus" aria-hidden="true"></i> Restore Bus Schedule</a>
				</li>
        </div> </div>
		...
		<form action="activate_bus_details.php" method="post">
			...
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">Enter a valid Bus No</td>
				</tr>
				<tr>
					<td class="fix_table"><input id="naekana" type="text" placeholder="Bus No" name="tablet_id" required></td>
				</tr>
			</table>
			<br>
