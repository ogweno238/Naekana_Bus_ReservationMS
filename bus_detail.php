				...
				if(empty($data_missing))
				{
					...
					*/
					if($affected_rows==1)
					{
						...
						header("location: add_bus.php?msg=success");
					}
					else
					{
						echo "Submit Error";
						echo mysqli_error();
						header("location: add_bus.php?msg=failed");
					}
				}
				else
				{
