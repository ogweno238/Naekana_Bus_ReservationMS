	...
	<head>
        ...
        <div class="row-fluid">
            <div class="span3">
				...
				<li><a href="booked_tickets.php"><i class="fa fa-bus" aria-hidden="true"></i> View Booked Bus Tickets</a>
				</li>
				<li class="active"><a href="print_booked_tickets.php"><i class="fa fa-bus" aria-hidden="true"></i> Print Booked Ticket</a>
				</li>
            ...
            <div class="container-fluid">    
                ...
                <div  id="divtop">
                    <center>
                        <br> <br><br>
                            <div id="dmain"  > 
                               <center><img src="admin/images/naekana.png" width="180px" height="150px" ></center>
                                <br>
