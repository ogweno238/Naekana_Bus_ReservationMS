...
--
-- Host: localhost
-- Generation Time: Mar 10, 2020 at 11:43 PM
...
--
-- Database: `naekana_bus`
--
CREATE DATABASE IF NOT EXISTS `naekana_bus` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `naekana_bus`;
...
('admin', '1212', 'admin', 'Harry Roshan', 'harryroshan1997@gmail.com');
...
CREATE TABLE IF NOT EXISTS `bus_details` (
  ...
  PRIMARY KEY (`bus_no`,`departure_date`),
...
INSERT INTO `bus_details` (`bus_no`, `from_city`, `to_city`, `departure_date`, `arrival_date`, `departure_time`, `arrival_time`, `seats_economy`, `seats_business`, `price_economy`, `price_business`, `tablet_id`) VALUES
...
--
-- Table structure for table `bus_login`
--

CREATE TABLE IF NOT EXISTS `bus_login` (
...
--
-- Dumping data for table `bus_login`
--

INSERT INTO `bus_login` (`customer_id`, `password`, `last_logindatetime`) VALUES
...
INSERT INTO `payment_details` (`payment_id`, `pnr`, `payment_date`, `payment_amount`, `payment_mode`, `customer_id`, ` booking_status`, `bus_no`) VALUES
...
CREATE TABLE IF NOT EXISTS `ticket_details` (
  ...
  KEY `bus_no` (`bus_no`),
  KEY `bus_no_2` (`bus_no`,`journey_date`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
