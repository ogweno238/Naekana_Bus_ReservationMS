     ...
     <div class="container">
        <div class="row-fluid">
            <div class="span3">
				...
				<li  class="active"><a href="delete_bus.php"><i class="fa fa-bus" aria-hidden="true"></i> Delete Bus Schedule</a>
				</li>
            ...
            <div class="hero-unit-3" style="background-color:#033">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;DEACTIVATE BUS</strong>
                        </div>
		<form action="deactivate_bus_details.php" method="post">
			
			<div>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>The Bus has been successfully deactivated.</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red'>*Invalid Bus No entered, please enter again.</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">Enter Bus NO.</td>
				</tr>
				<tr>
					<td class="fix_table"><input id="naekana" placeholder="Bus No" type="text" name="tablet_id" required></td>
				</tr>
			</table>
			<br>
