     ...
     <div class="container">
        <div class="row-fluid">
            <div class="span3">
				...
				<li  class="active"><a href="add_bus_shedule.php"><i class="fa fa-bus" aria-hidden="true"></i> Add Bus Schedule</a>
				</li>
        ...
        <div class="span9" style="background-color:#033">
            <div class="hero-unit-3" style="background-color:#033">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <form action="add_bus_handler.php" method="post">
			<h2> </h2>
			<?php
				...
				{
					echo "<strong style='color: red'>*Invalid Bus Schedule Details, please enter again.</strong>
						<br>
						<br>";
				}
			?>
